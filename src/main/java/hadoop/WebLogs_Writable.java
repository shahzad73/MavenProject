...
public class WebLogs_Writable implements WritableComparable<WebLogs_Writable> {
	   ...
	   //Custom Constructor
	   public WebLogs_Writable(IntWritable reqno, Text url, Text rdate, Text rtime, Text rip) 
	   {
		    this.siteURL = url;
		    this.reqDate = rdate;
	   ...
	   @Override
	   public int compareTo(WebLogs_Writable o) 
	   {
	   ...
	   {
	     if (o instanceof WebLogs_Writable) 
	     {
	       WebLogs_Writable other = (WebLogs_Writable) o;
